...
function Dynalinks_File_Proxy(dlink) {
    this.dlink = dlink, this.dynalinks = dlink;
}
...
Application.prototype.create_database = function(dynalinks) {
    ...
    new Dynalinks_File_Proxy(this.dynalinks).export_category(this.dynalinks.context.category_name);
}, Application.prototype.export_tag = function() {
    new Dynalinks_File_Proxy(this.dynalinks).export_tag(this.dynalinks.context.category_name, this.dynalinks.context.current_tag);
...
Vue.component("routed-link", {
    ...
    save_data_to_file: function(filename, data, varname) {
        ...
        console.log("blob created.... saving"), saveAs(blob, filename);
    },
    Database_Name: "database.txt",
    Database_Var: "my_links",
    export_tag: function(category, tag) {
        var data = this.dlink.get_category_context(category).pages[tag];
